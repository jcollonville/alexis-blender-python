...
|---|--------|----------------|------------------|
| 1 | [Mon objet](etape-01-mon-objet/) | Modeler à partir d’un cube (forme + couleur + nom) | `hello_blender.py` — retrouver l’objet |
| 2 | [Bouger](etape-02-bouger/) | Poser l’objet + une lumière | `bouger.py` — `location` (x / y / z) |
| 3 | [Tourner-grossir](etape-03-tourner-grossir/) | 2–3 keyframes à la main | `tourner_grossir.py` — `rotation_euler`, `scale`, boucle `for` |
| 4 | [Danser](etape-04-danser/) | 2–3 propriétés que tu choisis | `danser.py` — position + rotation |
